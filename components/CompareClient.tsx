...
const collegesData = [
  ...
  { 
    ...
    packageNum: 7,
    packageText: '₹6-8 LPA', 
    topSpecialization: 'HR & Marketing', 
    exams: 'Online Proctored', 
    mode: '100% Online', 
    lms: 'CU LMS',
    rating: 4.3
  ...
  { 
    ...
    feeNum: 3.00,
    feeText: '₹3.00 Lakhs', 
    accreditation: 'AICTE, UGC-DEB', 
    packageNum: 6,
    packageText: '₹5-7 LPA', 
    topSpecialization: 'Business Admin', 
    exams: 'On-Demand Online', 
  ...
  { 
    ...
    packageNum: 8,
    packageText: '₹7-9 LPA', 
    topSpecialization: 'Data Science', 
    exams: 'Semester-wise', 
    mode: '100% Online', 
    lms: 'SRM LMS',
    rating: 4.4
  ...
  { 
    ...
    packageNum: 7,
    packageText: '₹6-8 LPA', 
    topSpecialization: 'Oil & Gas, Power Mgt', 
    exams: 'Online', 
    mode: '100% Online', 
    lms: 'UPES Connect',
    rating: 4.3
  ...
  { 
    ...
    feeNum: 0.90,
    feeText: '₹90,000', 
    accreditation: 'UGC-DEB, NAAC B+', 
    packageNum: 4,
    packageText: '₹3-5 LPA', 
    topSpecialization: 'General Management', 
    exams: 'Online', 
    mode: '100% Online', 
    lms: 'Kalinga Portal',
    rating: 4.0
  ...
  { 
    ...
    packageNum: 5,
    packageText: '₹4-6 LPA', 
    topSpecialization: 'IT & Management', 
    exams: 'Online', 
    mode: '100% Online', 
    lms: 'PU LMS',
    rating: 4.1
