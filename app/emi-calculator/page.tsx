...
import { Calculator, IndianRupee, Clock, Percent, ShieldCheck, Zap, CreditCard, ChevronRight, CheckCircle2 } from 'lucide-react';
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-slate-950 text-white rounded-[2rem] p-8 shadow-2xl border border-slate-800 relative overflow-hidden">
               ...
               <div className="relative z-10">
                  ...
                  <button className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-black text-sm uppercase tracking-widest py-4 rounded-xl transition-all shadow-lg hover:shadow-indigo-500/25 active:scale-[0.98] flex items-center justify-center gap-2">
