...
## Ranked List
| Rank | College | Placement Rate | Avg. Salary (₹ LPA) | Notable Recruiters |
|---|---|---|---|---|
| 1 | **IIM Bangalore – e‑PGP** | 92% | 22‑30 | Deloitte, Amazon, McKinsey |
| 2 | **Symbiosis Centre for Distance Learning (SCDL)** | 88% | 15‑22 | Accenture, Infosys, Tata Consultancy |
| 3 | **NMIMS Global Access School** | 85% | 18‑25 | KPMG, HDFC Bank, Capgemini |
| 4 | **IGNOU – MBA (Distance)** | 73% | 12‑18 | Wipro, Reliance, L&T |
| 5 | **Jain University – Online MBA** | 78% | 14‑20 | Pepsico, IBM, Cognizant |
| 6 | **LPU (Lovely Professional University)** | 75% | 13‑19 | Paytm, Swiggy, Zomato |

## How Placement Cells Operate
- **Campus Drives** (virtual for online students)
